...
module.exports = (reporter, definition) => {
  ...
  reporter.on('after-authentication-express-routes', () => {
    return reporter.express.app.post('/api/worker-docker-manager', createRemoteRequestHandler(reporter.dockerManager.executeScript, reporter.dockerManager.executeRecipe))
  })
  ...
  reporter.initializeListeners.insert({ before: 'express' }, 'docker-workers', async () => {
    ...
    return reporter.dockerManager.init()
  })
