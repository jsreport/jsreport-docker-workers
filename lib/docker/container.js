...
module.exports = class Container {
  constructor ({
    ...
    this.tempVolumeSourcePath = path.join(this.tempDirectory, 'workers', this.id)
    ...
    if (tempVolumeSourcePrefix) {
      this.tempVolumeHostPath = normalizeWindowsPathForDocker(path.join(tempVolumeSourcePrefix, 'jsreport', 'workers', this.id))
    } else {
      this.tempVolumeHostPath = this.tempVolumeSourcePath
    }
  }
